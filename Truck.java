...
public class Truck {
	public static void main(String[]args) throws InterruptedException ,IOException {
		  ...
		  driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[1]/div[1]/select/option[14]")).click();
		  ...
		  WebElement kg =driver.findElement(By.id("payload"));
		  kg.sendKeys("500");
		  
		  WebElement Weigth =driver.findElement(By.id("totalweight"));
		  Weigth.sendKeys("9000");
  ...
  Thread.sleep(2000);
		  ...
		  File File1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		   FileUtils.copyFile(File1, new File("D:\\Project\\lib\\Screenshot.png"));
